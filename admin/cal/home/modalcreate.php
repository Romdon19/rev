...
<h4 class="modal-title" id="exampleModalLabel"><b>เพิ่มชื่อเรียก</b></h4>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
				...
				<input type="text"  name="calcode" class="form-control" maxlength="10" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text"  name="calname" class="form-control" maxlength="50" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
