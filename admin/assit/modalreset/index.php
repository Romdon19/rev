<!-- Bootstrap Modals -->
<!-- Modal -UPDATE- -->
<div class="modal fade" id="modalreset<?php echo $row['aid']; ?>" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel">
...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
			...
			<div class="col-md-12">
			<h5 style="text-align:center;">แบบฟอร์ม Reset Password</h5>
			...
			<div class="mb-3">
				...
				<option value="ผู้ดูแลรอง">ผู้ดูแลรอง</option>
					...
					<button type="submit" class="btn btn-outline-primary"><img src="../../../images/accept.png" width="24"> Reset</button>
					</div>
				</form>
	</div>
