...
<h4 class="modal-title" id="exampleModalLabel"><b>แก้ไขข้อผู้ดูแลระบบ</b></h4>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
			...
			<div class="mb-3">
				...
				<input type="text"  name="afname" class="form-control" maxlength="50" value="<?php echo $row['afname']?>">
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text"  name="alname" class="form-control" maxlength="50" value="<?php echo $row['alname']?>">
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text" name="uname" class="form-control" maxlength="25" value="<?php echo $row['uname']?>" disabled>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text" name="upass" class="form-control" maxlength="6" placeholder="" value="<?php echo $row['upass']?>">
				</div>
				</div>
				</div>
				</div>
				...
				<div class="mb-3">
				<div class="row">
				<div class="col-md-4" style="padding:0px 0px;"><span class="input-group-text" style="display:block;margin: auto;">ระดับ</span></div>
				<div class="col-md-8" style="padding:0px 0px;">
				<select name="cls" class="form-select" required>
				<option selected value="<?php echo $row['cls']?>"><?php echo $row['cls']?></option>
				<option value="ผู้ดูแลหลัก">ผู้ดูแลหลัก</option>
				<option value="ผู้ดูแลรอง">ผู้ดูแลรอง</option>
				</select>
				</div>
				</div>
				</div>
