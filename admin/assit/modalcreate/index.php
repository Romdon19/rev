...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
				...
				<input type="text"  name="afname" class="form-control" maxlength="50" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text"  name="alname" class="form-control" maxlength="50" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text" name="uname" class="form-control" maxlength="25" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
