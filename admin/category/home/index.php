...
<br>
<div class="row">
<h5 style="text-align:center;"><b>ประเภท</b></h5>
...
<div class="row">
	...
	<a href="#" class="btn btn-warning" data-bs-toggle="modal" data-bs-target="#modalupdate<?php echo $row['categoryid']; ?>" data-id=""><img src="../../../images/upd.png" width="24"></a>
	<a href="#" class="btn btn-danger" data-bs-toggle="modal" data-bs-target="#modaldelete<?php echo $row['categoryid'];?>" data-id=""><img src="../../../images/del.png" width="24"></a>
	<?php
