...
<body>
<div style="display:block;margin: auto;text-align: center;padding: 0px 0px 0px 0px;">
<img style="display:block;margin: auto;" src="../../../images/<?php echo $rowsetup['img'];?>" height="150">
</div>

  <nav class="navbar navbar-expand-lg bg-danger">
  <div class="container-fluid">
    <a style="color:white;" class="navbar-brand"><?php echo $rowsetup['office'];?><h6><?php echo $rowsetup['title'];?></h6></a>
