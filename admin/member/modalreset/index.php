<!-- Bootstrap Modals -->
<!-- Modal -UPDATE- -->
<div class="modal fade" id="modalreset<?php echo $row['mid']; ?>" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel">
...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
			...
			<div class="mb-3">
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text" name="tel" class="form-control" value="<?php echo $row['tel'] ?>" disabled>
				</div>
				</div>
				</div>
				</div>
