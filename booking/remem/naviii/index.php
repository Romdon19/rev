...
$resultbooking=$object->Readbooking($ckdate);
?>
<!doctype html>
<html lang="en">
<head>
...
<body>
 <nav class="navbar navbar-expand-lg bg-primary">
  <div class="container-fluid"><img style="display:block;margin: auto;" src="../../../images/<?php echo $rowsetup['img'];?>" height="60">
    <a style="color:white;width: 300px;"><h5><?php echo $rowsetup['office'];?></h5><h6><?php echo $rowsetup['title'];?></h6></a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <ul class="navbar-nav ms-auto topnav">
       <li class="nav-item">
        ...
        <li class="nav-item">
          <a style="color:white;" class="nav-link" href="../../../booking/"> จอง</a>
        </li>
        <li class="nav-item">
          <a style="color:white;" class="nav-link" href="../../../regis/"> ลงทะเบียน</a>
        </li>
        <li class="nav-item">
          <a style="color:white;" class="nav-link" href="../../../login/"> ผู้ดูแลระบบ</a>
        </li>
      </ul>
      </div>
  </div>
