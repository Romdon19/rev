<!-- Modal - DELETE -->
<div class="modal fade" id="modaldelete<?php echo $row['mid']; ?>" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog modal-lg" role="document">
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title" id="exampleModalLabel"><b>ยกเลิกลงทะเบียน</b></h4>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="col-md-12">
	<h5 style="text-align:center;">แบบฟอร์มยกเลิกข้อมูล</h5>
	...
	<button type="submit" name="submit" id="submit" class="btn btn-outline-danger"><img src="../../../images/accept.png" width="24"> ยืนยัน</button>
	</div>
	</form>
	</div>
