...
?>
<br>
<h5 style="text-align: center;"><b>รายการจอง</b></h5>
<div style="text-align: center;">
<a style="padding: 4px 12px 4px 12px;" href="../reserve/" class="btn btn-outline-primary"><img src="../../images/add.png" width="24"> จอง</a>
</div>
