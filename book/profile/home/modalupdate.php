...
<h4 class="modal-title" id="exampleModalLabel"><b>แก้ไขข้อมูลส่วนตัว</b></h4>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="col-md-12">
	<h5 style="text-align:center;">แบบฟอร์มแก้ไขข้อมูลส่วนตัว</h5>
	...
	<div class="form-group">
	<div class="input-group">
	<input type="text" name="password" class="form-control" value="<?php echo $row['password']?>" maxlength="6">
	</div>
	</div>
	</div>
	</div>
