...
$resultprofile=$object->Readprofile($mid);
...
<a style="color:white;width: 300px;"><h5><?php echo $rowsetup['office'];?></h5><h6>สมาชิก : <?php echo $_SESSION['mname'] ?></h6></a>
    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
      ...
      <ul class="navbar-nav ms-auto topnav">
       <li class="nav-item">
        ...
        <li class="nav-item">
          <a style="color:white;" class="nav-link" href="../../profile/"> ข้อมูลส่วนตัว</a>
        </li>
        <li class="nav-item">
