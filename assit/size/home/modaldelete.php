<!-- Bootstrap Modals -->
<!-- Modal - DELETE -->
<div class="modal fade" id="modaldelete<?php echo $row['sizeid']; ?>" tabindex="-1" data-bs-keyboard="false" data-bs-backdrop="static" role="dialog" aria-labelledby="myModalLabel">
<div class="modal-dialog modal-lg" role="document">
<div class="modal-content">
<div class="modal-header">
<h4 class="modal-title" id="exampleModalLabel"><b>ลบข้อมูล ขนาด / ลักษณะ / รูปร่าง</b></h4>
	...
	<div class="modal-body">
			...
			<h5 style="text-align:center;">แบบฟอร์มลบข้อมูล</h5>
				...
				<input type="text"  name="sizename" class="form-control" value="<?php echo $row['sizename']?>">
					...
					<button type="submit" name="submit" id="submit" class="btn btn-outline-danger"><img src="../../../images/del.png" width="24"> ยืนยันลบ</button>
					</div>
				</form>
	</div>
