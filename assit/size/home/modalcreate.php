...
<h4 class="modal-title" id="exampleModalLabel"><b>เพิ่มขนาด / ลักษณะ / รูปร่าง</b></h4>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
				...
				<input type="text"  name="sizename" class="form-control" maxlength="25" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
