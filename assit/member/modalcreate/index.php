...
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	...
	<div class="modal-body">
				...
				<input type="text"  name="fname" class="form-control" maxlength="50" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text"  name="lname" class="form-control" maxlength="50" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
				...
				<div class="form-group">
				<div class="input-group">
				<input type="text" name="email" class="form-control" maxlength="50" placeholder="" required>
				</div>
				</div>
				</div>
				</div>
