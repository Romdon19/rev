...
foreach($resultsetup as $rowsetup);
    $resultdatenow=$object->Readdatenow($ckdate);
    $resultforward=$object->Readforward($ckdate);
    $resultmember=$object->Readmember();
    $resultassit=$object->Readassit();
    $resultstarttime=$object->Readstarttime();
    $resultendtime=$object->Readendtime();
?>
<!doctype html>
<html lang="en">
<head>
...
<a style="color:white;width: 300px;"><h5><?php echo $rowsetup['office'];?></h5><h6>ผู้ดูแลรอง : <?php echo $_SESSION['aname'] ?></h6></a>
